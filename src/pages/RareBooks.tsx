...
import { RARE_BOOKS, type RareBook } from '@/utils/constants';
...
const RareBooks: React.FC = () => {
  ...
  const filteredBooks = RARE_BOOKS.filter((book) =>
              ...
              <div className="p-6 lg:p-8">
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="p-4 bg-secondary rounded-lg">
                    ...
                    <p className="font-semibold text-foreground">{selectedBook.year}</p>
                  </div>
                  <div className="p-4 bg-secondary rounded-lg">
                    <span className="text-sm text-muted-foreground">Pages</span>
                    <p className="font-semibold text-foreground">{selectedBook.pages}</p>
                  </div>
                  <div className="p-4 bg-secondary rounded-lg">
                    <span className="text-sm text-muted-foreground">Condition</span>
                    <p className="font-semibold text-foreground">{selectedBook.condition}</p>
                  </div>
                  <div className="p-4 bg-secondary rounded-lg">
                    <span className="text-sm text-muted-foreground">Availability</span>
                    <p className="font-semibold text-foreground">{selectedBook.availability}</p>
                  </div>
                </div>
